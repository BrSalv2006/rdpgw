...
/* Common Error Code */
const (
	ERROR_SUCCESS                               uint32 = 0x00000000
	...
	E_PROXY_TS_CONNECTFAILED                    uint32 = 0x000059DD
	E_PROXY_MAXCONNECTIONSREACHED               uint32 = 0x000059E6
	// E_PROXY_INTERNALERROR                       = 0x000059D8
	ERROR_GRACEFUL_DISCONNECT                   uint32 = 0x000004CA
	E_PROXY_NOTSUPPORTED                        uint32 = 0x000059E8
	SEC_E_LOGON_DENIED                          uint32 = 0x8009030C
	E_PROXY_SESSIONTIMEOUT                      uint32 = 0x000059F6
	E_PROXY_REAUTH_AUTHN_FAILED                 uint32 = 0x000059FA
	E_PROXY_REAUTH_CAP_FAILED                   uint32 = 0x000059FB
	E_PROXY_REAUTH_RAP_FAILED                   uint32 = 0x000059FC
	E_PROXY_SDR_NOT_SUPPORTED_BY_TS             uint32 = 0x000059FD
	E_PROXY_REAUTH_NAP_FAILED                   uint32 = 0x00005A00
	E_PROXY_CONNECTIONABORTED                   uint32 = 0x000004D4
)
